...
export function makeProjects() {
  ...
  projects.push(
    new Project(
      ...
      "My Family Tree",
      false,
      "https://genealogy-site.herokuapp.com/,https://github.com/PlasmaDiffusion/Genealogy-Site",
      "A genealogy based website made for a client. Admins can submit data on families and individual people through forms. Anyone can view the data entered on specific families.,This project was made primarily to get acquainted with React. It also makes use of MongoDB with NodeJS.",
      null,
  ...
  projects.push(
    new Project(
      ...
      "PaintOn",
      false,
      "https://painton.herokuapp.com/,https://github.com/PlasmaDiffusion/PaintOn",
  ...
  projects.push(
    new Project(
      ...
      "Robots & Things",
      true,
      "https://robots-and-things.manakeep.com/,,A 3D platformer game that mixes open exploration and linear levels together.",
  ...
  projects.push(
    new Project(
      ...
      "Hyper Snake",
      true,
      "https://play.google.com/store/apps/details?id=com.PlasmaShadowGames.HypeSnake&hl=en_CA&gl=US,https://github.com/PlasmaDiffusion/Snake-Adventure",
